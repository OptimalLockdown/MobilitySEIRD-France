...
#from src.distance import EuclideanNone
...
observation_france = np.load(data_folder + "observed_data.npy", allow_pickle=True)

print(observation_france.shape)
...
model = SEI4RD(
    [beta, d_L, d_C, d_R, d_RC, d_D, p01, p02, p03, p04, p05, p11, p12, p13, p14, p15, initial_exposed, alpha_123,
     alpha_4, alpha_5], tot_population=total_population, T=T, contact_matrix_school=contact_matrix_school,
    contact_matrix_work=contact_matrix_work, contact_matrix_home=contact_matrix_home,
    contact_matrix_other=contact_matrix_other, alpha_school=alpha_school, alpha_work=alpha_work,
...
# # inference1
# print("Inference 1")
# jrnl = ABC_inference("PMCABC", model, observation_france, final_distance, eps=eps, n_samples=500, n_steps=5,
...
# jrnl = ABC_inference("PMCABC", model, observation_france, final_distance, eps=eps, n_samples=500, n_steps=10,
