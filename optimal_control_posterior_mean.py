...
def plot_different_epsilon_results_post_mean(epsilon_school, epsilon_work, epsilon_other, window_size=30,
    ...
    main(epsilon=[epsilon_school, epsilon_work, epsilon_other], sigma=1, window_size=window_size,
         ...
         plot_file="mode_eps_{}_{}_{}_window_{}_post_samples_{}".format(
...
# is the lockdown day OK for France? The value here was also used in the inference code.
# What about NHS max for France? Is that correct?
# Is journal_5 correct?